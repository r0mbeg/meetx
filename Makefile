...
dev-up-backend:
	docker compose -f compose.yml -f compose.dev.yml up postgres backend -d

dev-up-postgres:
	docker compose -f compose.yml -f compose.dev.yml up postgres -d
...
help:
	...
	@echo "  dev-up-postgres - Start development database"
